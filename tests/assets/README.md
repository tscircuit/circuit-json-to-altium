...
[after cleanup](./ti-tps61288-junctions-cleaned.SchDoc) export the
...
Native junction size and color settings are unchanged. The local SVG preview
does not show Altium's compiler-generated auto-junction markers.
