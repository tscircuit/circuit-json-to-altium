...
test("reproduces the Consumer Wireless Module generated system", async () => {
  ...
  expect(upperLabel!.width).toBeLessThanOrEqual(80.004)
  // Scaled integer text needs slightly more width than the old 3.6 pt estimate.
  expect(lowerLabel!.width).toBeLessThanOrEqual(80.004)
